...
})({"iM5K2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "WeaponTracker", ()=>WeaponTracker);
...
function WeaponTracker() {
    ...
    (0, _react.useEffect)(()=>{
        if (!lists) return;
        if (!lists.standard) setLists({
            ...lists,
            standard: []
        });
        if (!lists.salmon) setLists({
            ...lists,
            salmon: []
        });
        if (!lists.grizzco) setLists({
            ...lists,
            grizzco: []
        });
        if (!lists.order) setLists({
            ...lists,
            order: []
        });
    }, [
    ...
    (0, _react.useEffect)(()=>{
        if (importError !== "") errorTimeout.current = window.setTimeout(()=>{
            setImportError("");
        }, 10000);
        return ()=>{
    ...
    const weaponSize = (0, _react.useMemo)(()=>{
        if (!mode) return 0;
        switch(mode){
    ...
    const resetList = (0, _react.useCallback)(()=>{
        if (!mode) return;
        if (!lists) return;
        switch(mode){
            case (0, _types.WeaponMode).Standard:
    ...
    const importList = (0, _react.useCallback)((acceptedFiles)=>{
        if (!lists) {
        ...
        file.text().then((value)=>{
            try {
                ...
                if (importedJSON.mode && importedJSON.weaponIds) switch(importedJSON.mode){
                    case (0, _types.WeaponMode).Standard:
                        setLists({
                            ...lists,
                            standard: importedJSON.weaponIds
                        });
                        break;
                    case (0, _types.WeaponMode).Salmon:
                        setLists({
                            ...lists,
                            salmon: importedJSON.weaponIds
                        });
                        break;
                    case (0, _types.WeaponMode).Grizzco:
                        setLists({
                            ...lists,
                            grizzco: importedJSON.weaponIds
                        });
                        break;
                    case (0, _types.WeaponMode).Order:
                        setLists({
                            ...lists,
                            order: importedJSON.weaponIds
                        });
                        break;
                    default:
                        setImportError(`List file contained unknown Weapon Mode "${importedJSON.mode}"`);
                }
                else setImportError("The file provided failed to be matched as a weapon list file.");
            } catch (error) {
    ...
    const removeFromList = (0, _react.useCallback)((index)=>{
        if (!mode) return;
        if (!lists) return;
        switch(mode){
            case (0, _types.WeaponMode).Standard:
                setLists({
                    ...lists,
                    standard: lists.standard.filter((item, itemIndex)=>itemIndex !== index)
                });
                break;
            case (0, _types.WeaponMode).Salmon:
                setLists({
                    ...lists,
                    salmon: lists.salmon.filter((item, itemIndex)=>itemIndex !== index)
                });
                break;
            case (0, _types.WeaponMode).Grizzco:
                setLists({
                    ...lists,
                    grizzco: lists.grizzco.filter((item, itemIndex)=>itemIndex !== index)
                });
                break;
            case (0, _types.WeaponMode).Order:
                setLists({
                    ...lists,
                    order: lists.order.filter((item, itemIndex)=>itemIndex !== index)
                });
                break;
        }
    }, [
    ...
    const addToList = (0, _react.useCallback)((id)=>{
        if (!mode) return;
        if (!lists) return;
        switch(mode){
            case (0, _types.WeaponMode).Standard:
    ...
    const exportList = (0, _react.useCallback)(()=>{
        ...
        (0, _fileSaver.saveAs)(blob, `${mode}List.json`);
    }, [
        mode,
        activeList
    ]);
    return /*#__PURE__*/ (0, _reactDefault.default).createElement(Wrapper, {
        ...
        __self: this
    }, /*#__PURE__*/ (0, _reactDefault.default).createElement(Modes, {
        ...getRootProps(),
        __source: {
            fileName: "src/dashboard/WeaponTracker.tsx",
            lineNumber: 308,
        ...
        onClick: ()=>{
            setDisplay((0, _types.DisplayMode).Recent);
        },
        __source: {
            fileName: "src/dashboard/WeaponTracker.tsx",
            lineNumber: 323,
        ...
        $content: "Show Freqs",
        $colorTag: "control",
        $selected: display === (0, _types.DisplayMode).Frequencies,
        onClick: ()=>{
            setDisplay((0, _types.DisplayMode).Frequencies);
        },
        __source: {
            fileName: "src/dashboard/WeaponTracker.tsx",
            lineNumber: 326,
        ...
        $content: "Show Unseen",
        $colorTag: "control",
        $selected: display === (0, _types.DisplayMode).Unseen,
        onClick: ()=>{
            setDisplay((0, _types.DisplayMode).Unseen);
        },
        __source: {
            fileName: "src/dashboard/WeaponTracker.tsx",
            lineNumber: 329,
        ...
        __self: this
    }, importError !== "" && /*#__PURE__*/ (0, _reactDefault.default).createElement(ErrorText, {
        $colorTag: "reset",
...
const Wrapper = (0, _styledComponents.styled).div.withConfig({
    displayName: "WeaponTracker__Wrapper",
    componentId: "sc-zd7xol-0"
})([
    "position:relative;display:grid;grid-template-columns:max-content 1fr;"
]);
const Modes = (0, _styledComponents.styled).div.withConfig({
...
const ErrorText = (0, _styledComponents.styled)((0, _layout.HeadText)).withConfig({
    ...
    componentId: "sc-zd7xol-2"
})([
    "position:relative;margin-left:5px;width:100%;"
]);
const Options = (0, _styledComponents.styled).div.withConfig({
...
], ({ $size })=>$size + 10, ({ $smallGap })=>$smallGap ? (0, _styledComponents.css)([
        "column-gap:10px;"
...
},{"react":"bH1AQ","react-dom/client":"i5cPj","styled-components":"9xpRL","../utils/WeaponDatabase":"kbTcL","./components/Layout":"72fYZ","../utils/use-replicant":"8lJRU","../types/types":"2nPdh","./components/WeaponList":"7EObH","./components/RecentList":"f6VhE","react-dropzone":"gDtXJ","file-saver":"khXis","./components/CollapseContainer":"hrG5d","./components/RollWeapons":"5xrWy","@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}],"7EObH":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "WeaponList", ()=>WeaponList);
var _react = require("react");
var _reactDefault = parcelHelpers.interopDefault(_react);
var _styledComponents = require("styled-components");
...
const Wrapper = (0, _styledComponents.styled).div.withConfig({
    displayName: "WeaponList__Wrapper",
    componentId: "sc-v5vro3-0"
})([
    "position:relative;overflow:auto;"
]);
const Row = (0, _styledComponents.styled).div.withConfig({
    displayName: "WeaponList__Row",
    componentId: "sc-v5vro3-1"
})([
    "position:relative;display:flex;flex-direction:row;flex-wrap:wrap;"
]);
const HeadWrapper = (0, _styledComponents.styled).div.withConfig({
    displayName: "WeaponList__HeadWrapper",
    componentId: "sc-v5vro3-2"
})([
    "position:relative;padding-left:5px;"
]);

},{"react":"bH1AQ","styled-components":"9xpRL","./Layout":"72fYZ","./WeaponButton":"cadws","../../utils/WeaponDatabase":"kbTcL","@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}],"cadws":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"react":"bH1AQ","styled-components":"9xpRL","./Layout":"72fYZ","../../utils/WeaponDatabase":"kbTcL","@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}],"f6VhE":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "RecentList", ()=>RecentList);
var _react = require("react");
var _reactDefault = parcelHelpers.interopDefault(_react);
var _styledComponents = require("styled-components");
var _weaponDatabase = require("../../utils/WeaponDatabase");
...
},{"react":"bH1AQ","styled-components":"9xpRL","../../utils/WeaponDatabase":"kbTcL","./WeaponButton":"cadws","@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}],"gDtXJ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function useDropzone() {
    ...
    var acceptAttr = (0, _react.useMemo)(function() {
        return (0, _index.acceptPropAsAcceptAttr)(accept);
    }, [
        accept
    ]);
    var pickerTypes = (0, _react.useMemo)(function() {
        return (0, _index.pickerOptionsFromAccept)(accept);
    }, [
        accept
    ]);
   ...
   */ var rootRef = (0, _react.useRef)(null);
    ...
    var fsAccessApiWorksRef = (0, _react.useRef)(typeof window !== "undefined" && window.isSecureContext && useFsAccessApi && (0, _index.canUseFileSystemAccessAPI)()); // Update file dialog active state when the window is focused on
    ...
    var setFiles = (0, _react.useCallback)(function(files, event) {
        ...
        files.forEach(function(file) {
            var _fileAccepted = (0, _index.fileAccepted)(file, acceptAttr), _fileAccepted2 = _slicedToArray(_fileAccepted, 2), accepted = _fileAccepted2[0], acceptError = _fileAccepted2[1];
    ...
    var openFileDialog = (0, _react.useCallback)(function() {
        ...
        if (fsAccessApiWorksRef.current) {
            ...
            window.showOpenFilePicker(opts).then(function(handles) {
                ...
                if ((0, _index.isAbort)(e)) {
                    onFileDialogCancelCb(e);
                    dispatch({
                        type: "closeDialog"
                    });
                } else if ((0, _index.isSecurityError)(e)) {
...
},{"react":"bH1AQ","prop-types":"4nQRB","file-selector":"a4GZG","./utils/index":"83cP5","./utils":false,"@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}],"4nQRB":[function(require,module,exports,__globalThis) {
/**
...
},{"96e34ae03f5a2631":"jorYx","cb216452e2171041":"1hXKM"}],"jorYx":[function(require,module,exports,__globalThis) {
'use strict';
module.exports = require("2255125a8e8b1051");

},{"2255125a8e8b1051":"3BcZY"}],"3BcZY":[function(require,module,exports,__globalThis) {
...
},{}],"1hXKM":[function(require,module,exports,__globalThis) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"c437388b089702c3":"jorYx","c067a60101d8520c":"bNXVA","74a0f89a70b9f3c2":"bZWAr","18441b11647bc78":"1ojSU","bec3f6ff89f0b072":"9LQJE"}],"bNXVA":[function(require,module,exports,__globalThis) {
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{}],"bZWAr":[function(require,module,exports,__globalThis) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{}],"1ojSU":[function(require,module,exports,__globalThis) {
module.exports = Function.call.bind(Object.prototype.hasOwnProperty);

},{}],"9LQJE":[function(require,module,exports,__globalThis) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"24ba1e58d167a82c":"bZWAr","898bc82f39d83f7c":"1ojSU"}],"a4GZG":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fromEvent", ()=>(0, _fileSelector.fromEvent));
var _fileSelector = require("./file-selector");

},{"./file-selector":"dv4XQ","@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}],"dv4XQ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
},{"tslib":"lRaYF","./file":"7YIJG","@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}],"lRaYF":[function(require,module,exports,__globalThis) {
/******************************************************************************
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}],"7YIJG":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}],"83cP5":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"attr-accept":"il8tO","@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}],"il8tO":[function(require,module,exports,__globalThis) {
"use strict";
...
},{}],"khXis":[function(require,module,exports,__globalThis) {
...
},{}],"hrG5d":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
